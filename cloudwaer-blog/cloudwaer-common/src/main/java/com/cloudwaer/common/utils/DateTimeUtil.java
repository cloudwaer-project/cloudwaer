...
public class DateTimeUtil {
    ...
    public static final String DATE_FORMAT_HH = "yyyy-MM-dd HH:mm";
    ...
    public static final String DATE_FORMAT_UK = "EEE MMM dd HH:mm:ss Z yyyy";
    // change by bbq
     ...
     * @see #getFormatDate(java.util.Date, String)
     */
    public static Date getFirstDayOfMonthV2() {
        Calendar cal = Calendar.getInstance();
        int firstDay = cal.getMinimum(Calendar.DAY_OF_MONTH);
        cal.set(Calendar.DAY_OF_MONTH, firstDay);
        return cal.getTime();
    ...
    /**
     * 得到格式化后的上月第一天，格式为yyyy-MM-dd，如2006-02-01
     *
     * @return String 返回格式化后的上月第一天，格式为yyyy-MM-dd，如2006-02-01
     * @see java.util.Calendar#getMinimum(int)
     * @see #getFormatDate(java.util.Date, String)
     */
    ...
    /**
     * 得到格式化后的上月最后一天，格式为yyyy-MM-dd，如2006-02-01
     *
     * @return String 返回格式化后的上月最后一天，格式为yyyy-MM-dd，如2006-02-01
     * @see java.util.Calendar#getMinimum(int)
     * @see #getFormatDate(java.util.Date, String)
     */
    ...
    /**
     * @param dt   传入日期，可以为空
     * @param diff 需要获取相隔diff小时的日期 如果为正则取以后的日期，否则时间往前推
     * @return
     */
    public static String getDiffHourseStringDate(Date dt, int diff) {
        Calendar ca = Calendar.getInstance();
        ...
        ca.add(Calendar.HOUR, diff);
        SimpleDateFormat dtFormatdB = new SimpleDateFormat("yyyy-MM-dd HH:00");
        return dtFormatdB.format(ca.getTime());
    }
    ...
    public static double yearBetween(Date smdate, Date bdate) {
        ...
        BigDecimal b = new BigDecimal(days / 365.0);
    ...
    public static String getExcelFileDate(String str) {
        SimpleDateFormat sdf1 = new SimpleDateFormat(DATE_FORMAT_UK, Locale.UK);
        Date date = null;
        String newDate = "";
        try {
            date = sdf1.parse(str);
    ...
    public static String stringToString(String str) {
        Date result = getFormatDate(str, DATE_FORMAT_HH);
        SimpleDateFormat sdf = new SimpleDateFormat(DATE_FORMAT_HH);//这个是你要转成后的时间的格式
        String strtodate  = sdf.format(result);
        return strtodate;
